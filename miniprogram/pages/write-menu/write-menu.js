...
Page({
    ...
    handleWriteApp() {
        if (!this.data.canDeviceProcessNFC) {
            showPixelToast({ message: '设备不支持NFC功能', theme: 'warning' });
            return;
        }
        wx.navigateTo({ url: '/pages/write-app/write-app' });
    },
    ...
    handleWriteMusic() {
        ...
        wx.navigateTo({ url: '/pages/write-music/write-music' });
    },
    ...
    handleWriteWeb() {
        ...
        wx.navigateTo({ url: '/pages/write-web/write-web' });
    },
    ...
    handleCloseDeveloperPromiseDialog() {
        ...
        this.setData({ developerPromiseDialogVisible: false });
    },
    ...
    handleCloseUnsupportedDialog() {
        this.setData({ nfcUnsupportedDialogVisible: false });
    },
});
